...
<html>
<head>
	<title> View Jobseeker's Profile </title>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="card-title">
              <h3>
                <?php
                  $query = "SELECT * FROM `job enrollment system`.`jobseeker_personal_details`";
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  <?php
                    ...
                    $sql = "SELECT * FROM `job enrollment system`.`jobseeker_personal_details` ";
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                      ...
                      $c_name = $row['JS_Name']; 
                      $c_profession = $row['JS_Profession']; 
                      $c_email = $row['JS_EmailID']; 
                      $c_img = $row['JS_ProfileImg_name']; 
                                                                              
                      echo "
                        <tr>
                          <td><img src='../../JobSeeker Section/Profile Page/upload/".$c_img." ' alt=''></td>
                          <td>".$c_name."</td>
                          <td>".$c_profession."</td>
                          <td>".$c_email."</td>
                          <td>
                            <form method='post'>
                              ...
                              <button type='submit' class='btn' name='details-btn' formaction='candidateProfile.php'> 
