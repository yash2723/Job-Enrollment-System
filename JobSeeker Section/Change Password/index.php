<?php
    ...
    if (isset($_POST['update-pass-btn'])) {
        ...
        $sql = "SELECT `JS_Password` FROM `job enrollment system`.`jobseeker_basic_details` WHERE JS_EmailID='$login_mail' ";

        $result = mysqli_query($con,$sql);

        while ($row = mysqli_fetch_array($result)) {
            $user_pass = $row['JS_Password']; 
            ...
            if (isset($_POST['old-pass'])) {
                ...
                if ($user_pass == $old_pass) {
                    ...
                    $sql = "UPDATE `job enrollment system`.`jobseeker_basic_details` SET `JS_Password`='$new_pass' WHERE JS_EmailID='$login_mail' ";

                    if($con->query($sql) == true)
                    {
                        // echo "Successfully Updated.";
                        echo '<script>alert("Password has been Sucessfully Updated.")</script>';
                    }

                }
                else {
                    // echo "Old Password is no correct";
                    echo '<script>alert("Old password is no correct.")</script>';
                }
...
<body>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            ...
            <li class="nav-item">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    ...
                    <li><a style="color: #6c63ff;" class="dropdown-item" href="../Change Password/index.php">Change Password</a></li>
    ...
    <!-- End Responsive navigation icon -->
            ...
            <div class="col-8">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3" method="POST" action="index.php" onsubmit="return validateForm()">

                            <div class="col-md-6" style="width: 100%;">
                                <label for="inputPassword1" class="form-label">Old Password :</label>
                                <input type="password" name="old-pass" class="form-control" id="inputPassword1" placeholder="">
                            </div>

                            <div class="col-md-6">
                                <label for="inputPassword2" class="form-label">New Password :</label>
                                <input type="password" name="new-pass" class="form-control" id="inputPassword2" placeholder="">
                            </div>

                            <div class="col-md-6">
                                <label for="inputPassword3" class="form-label">Confirm New Password :</label>
                                <input type="password" name="confirm-new-pass" class="form-control" id="inputPassword3" placeholder="">
                            </div>

                            <div class="col-12">
                                <button type="submit" name="update-pass-btn" class="btn btn-primary">Update Password</button>
                            </div>
