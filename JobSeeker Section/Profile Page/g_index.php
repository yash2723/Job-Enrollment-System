        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            ...
            <li class="nav-item">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    ...
                    <li><a class="dropdown-item" href="#">Mange Questions</a></li>
                    <li><a class="dropdown-item" href="#">Show Details</a></li>
                </ul>
                </div>
                    ...
                    <div class="col-3" style="width: 18rem; margin: auto;">
                        ...
                        <div class="card" style="width: 16rem;">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <a href="../Job Alerts/index.php">
                                    <li class="list-group-item">
                                        <!-- <img src="./images/alert-icon-transparent.png" alt=""> -->
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                ...
                                <li class="list-group-item">
                                    <!-- <img src="./images/management-icon-transparent.png" alt=""> -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="index.php" method="post" class="row g-3" onsubmit="return validateForm()">
                            ...
                            <div class="col-md-6">
                                <label for="input-language" class="form-label">Languages :</label>
                                <input type="text" name="language" value="<?php if($flag == 1){ echo $col3;}?>"
                                    class="form-control" id="input-language" placeholder="English, Gujarati, Hindi">
                            </div>
