            ...
            <div class="col-md-4 py-5 background">
             <!-- first col 2->
                ...
                <div class="text-center profile-img">
                    <?php
                    if ($col14) {
                        echo '<img src="../Profile Page/upload/'.$col14.' " " class="img-fluid myimg" alt="..." style="height: 230px; width: 240px">';
                    }
                    else {
                ...
                <div class="first_col">
                    ...
                    <div class="container" id="contact_container">
                        ...
                        ?>
                        <!-- <p><a href="www.linkedin.com" class="li-link"> <i class="fab fa-linkedin-in"></i> &nbsp; www.linkedin.com</a></p>
                        <p><a href="www.facebook.com" class="fb-link"> <i class="fab fa-github"></i> &nbsp; www.gihub.com</a></p> 
                        <p><a href="www.facebook.com" class="fb-link"> <i class="fab fa-facebook"></i> &nbsp; www.facebook.com</a></p> -->
